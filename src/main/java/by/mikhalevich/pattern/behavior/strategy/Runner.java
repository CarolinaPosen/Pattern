 ...
 *
 * Стратегия часто используется в Java-коде,
 * особенно там, где нужно подменять алгоритм
 * во время выполнения программы.
 * Начиная с Java 8, многие примеры стратегии
 * можно заменить простыми lambda-выражениями.
 */
public class Runner {
